    ...
    <div class="card-info-wrapper-profile-creation">
      <div class="card-info">
        <div class="card-info-title">
          ...
          <p style="color: grey;">Our cutting-edge technology ensures the integrity of your digital content while maintaining the highest quality.</p>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="card-content">
      ...
      <div class="card-info-wrapper-profile-creation">
        <div class="card-info">
          <div class="card-info-title">
            <h3>
              Upload any and all of your media content to generate a protected version
            </h3>
          </div>
        </div>
      </div>
